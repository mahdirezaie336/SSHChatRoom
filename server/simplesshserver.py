...
$ ckeygen -t rsa -f ssh_keys/ssh_host_rsa_key
$ ckeygen -t rsa -f ssh_keys/client_rsa
...
$ ssh -p 5022 -i ssh_keys/client_rsa user@localhost
# Connect with the SSH client key.
$ ssh -p 5022 -i ssh_keys/client_rsa user@localhost
"""

# Path to RSA SSH keys used by the server.
SERVER_RSA_PRIVATE = "ssh_keys/ssh_host_rsa_key"
SERVER_RSA_PUBLIC = "ssh_keys/ssh_host_rsa_key.pub"

# Path to RSA SSH keys accepted by the server.
CLIENT_RSA_PUBLIC = "ssh_keys/client_rsa.pub"
